...
// import '@material-ui/lab/themeAugmentation/index';
import IranYekan from './fonts/IranYekan/woff2/IRANYekanXFaNum-Medium.woff2'
import IranYekanBold from './fonts/IranYekan/woff2/IRANYekanXFaNum-Bold.woff2'
import IranYekanLight from './fonts/IranYekan/woff2/IRANYekanXFaNum-Light.woff2'
...
export const PureLightTheme = createTheme({
    ...
    MuiCssBaseline: {
      styleOverrides: `
        @font-face {
          ...
          font-display: swap;
          font-weight: 400;
          src: local('IranYekan'), local('IranYekan-Medium'), url(${IranYekan}) format('woff2');
        ...
        @font-face {
         ...
         @font-face {
          ...
          font-display: swap;
          font-weight: 300;
          src: local('IranYekan'), local('IranYekan-Light'), url(${IranYekanLight}) format('woff2');
          unicodeRange: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF;
        }
         @font-face {
          font-family: 'IranYekan';
          ...
          font-display: swap;
          font-weight: 700;
          src: local('IranYekan'), local('IranYekan-Bold'), url(${IranYekanBold}) format('woff2');
          unicodeRange: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF;
        }
      `,
        'html, body': {
  ...
  typography: {
    fontFamily:
      'IranYekan, -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
    h1: {
      fontWeight: 700,
      fontSize: 35
    },
